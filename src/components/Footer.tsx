import { Facebook, Twitter, Linkedin, Instagram, Mail, Phone, MapPin, Cross } from 'lucide-react';
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          <div>
            ...
            <div className="flex items-center gap-2 mb-6">
              ...
              <span className="text-2xl font-bold text-white tracking-tight">Pharmacy</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="mailto:info@medequip.com" className="hover:text-primary-400 transition-colors">
                  info@pharmacy.com
                </a>
              </li>
            </ul>
